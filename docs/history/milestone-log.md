# Milestone log — M01 to M07

This is the running narrative that `IMPLEMENTATION_PLAN.md` carried while
milestones M01–M07 were built: one entry per completed tranche, written as that
tranche finished. M07.5 moved it here so the root work queue is a queue rather
than a history.

**It is frozen, and it is not the current record.** Each entry says what was true
on the day it was written, and several were overtaken by later entries in this
same file — M01.2's entry counts cards that M02.6 finished, and M04.1's closing
note describes a stall threshold that M04.3 replaced with a versioned definition.
Nothing here is updated. Where this file and a live document disagree, the live
document is right.

| Question                                       | The document that answers it                                                          |
| ---------------------------------------------- | ------------------------------------------------------------------------------------- |
| What rule is settled and implemented?          | [`docs/rules/confirmed-rules.md`](../rules/confirmed-rules.md)                        |
| What is implemented but provisional?           | [`docs/rules/open-decisions.md`](../rules/open-decisions.md)                          |
| What has no answer yet?                        | [`docs/open-questions.md`](../open-questions.md)                                      |
| How many cards, which versions, what coverage? | [`docs/status-audit.md`](../status-audit.md), generated and checked on every test run |
| What did each milestone make true?             | [`docs/project-status.md`](../project-status.md)                                      |
| What was a tranche's scope, and its checklist? | [`docs/milestones/`](../milestones/)                                                  |
| What is the next bounded task?                 | [`IMPLEMENTATION_PLAN.md`](../../IMPLEMENTATION_PLAN.md)                              |

## M01 — Truthfulness and verification

Tranche detail and checklist: [`docs/milestones/M01-truthfulness-and-verification.md`](../milestones/M01-truthfulness-and-verification.md).
...
## M02 — Remaining card mechanics

Tranche detail and checklist: [`docs/milestones/M02-remaining-card-mechanics.md`](../milestones/M02-remaining-card-mechanics.md).
...
## M03 — Precon integration

Tranche detail and checklist: [`docs/milestones/M03-precon-integration.md`](../milestones/M03-precon-integration.md).
...
## M04 — Shared board telemetry

Tranche detail and checklist: [`docs/milestones/M04-shared-board-telemetry.md`](../milestones/M04-shared-board-telemetry.md).
...
Tranche detail and checklist: [`docs/milestones/M05-ai-reliability.md`](../milestones/M05-ai-reliability.md).
...
## M06 — Token presentation

Tranche detail and checklist: [`docs/milestones/M06-token-presentation.md`](../milestones/M06-token-presentation.md).
...
## M07 — Documentation consolidation

Tranche detail and checklist: [`docs/milestones/M07-documentation-consolidation.md`](../milestones/M07-documentation-consolidation.md).
