...
| Reading          | Value                                       |
| ---------------- | ------------------------------------------- |
| Commit           | `e6e77d7e2174dae62fe0d78bfb051e850a384405`  |
...
| Constant                   | Value | Pins                                                                                                                                   |
| -------------------------- | ----- | -------------------------------------------------------------------------------------------------------------------------------------- |
| `ADMIN_CONTRACT_VERSION`   | 4     | The request and response language `apps/admin-client` and `apps/admin-server` speak. Compared per request.                             |
